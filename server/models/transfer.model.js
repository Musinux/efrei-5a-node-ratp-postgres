...
export default class Transfer {
  ...
  static async generateTable () {
    ...
    `)
    await postgresStore.client.query(`
      CREATE INDEX transfer_from_stop_id_to_stop_id ON transfer(from_stop_id, to_stop_id)
    `)
    await postgresStore.client.query(`
      CREATE INDEX transfer_from_stop_id ON transfer(from_stop_id)
    `)
    await postgresStore.client.query(`
      CREATE INDEX transfer_to_stop_id ON transfer(to_stop_id)
    `)
  }
}
